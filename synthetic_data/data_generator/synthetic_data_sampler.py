import sys 
sys.path.append("../")
from data_generator.data_utils import generate_input_trees, simulate_outcome, process_trees_and_create_csvs, expand_features, observational_sampling, add_order_of_modules
from data_generator.tree_data_structures import Node, ExpressionNode, QueryPlanNode
import numpy as np
import random
import os
import shutil
...
from data_generator.synthetic_modules import *
...
class SyntheticDataSampler:
    def __init__(
        ...
        self.base_dir = "{}/data".format(ROOT_DIR)
    ...
    def initialize_folders(self):
        ...
        self.data_path = "{}/jsons/fixed_structure_{}_outcomes_{}_systematic_{}".format(self.base_dir, self.fixed_structure, self.composition_type, self.systematic)
        folder_0 = "data_0"
        folder_1 = "data_1"
        ...
        self.csv_folder = "{}/csvs/fixed_structure_{}_outcomes_{}_systematic_{}".format(self.base_dir, self.fixed_structure, self.composition_type, self.systematic)
        ...
        self.obs_csv_folder = "{}/observational_data/fixed_structure_{}_outcomes_{}_systematic_{}".format(self.base_dir, self.fixed_structure, self.composition_type, self.systematic)
        if not os.path.exists(self.obs_csv_folder):
            os.makedirs(self.obs_csv_folder)

        self.plot_folder = "{}/plots/fixed_structure_{}_outcomes_{}_systematic_{}".format(self.base_dir,  self.fixed_structure, self.composition_type, self.systematic)
        if not os.path.exists(self.plot_folder):
            os.makedirs(self.plot_folder)

        self.config_folder = "{}/config/fixed_structure_{}_outcomes_{}_systematic_{}".format(self.base_dir,  self.fixed_structure, self.composition_type, self.systematic)
    ...
    def simulate_potential_outcomes(self, treatment_id, use_subset_features=False, batch_size=10000):
        ...
        for i, tree in enumerate(self.input_trees):
            ...
            # Uncomment to save the input trees in jsons folder
