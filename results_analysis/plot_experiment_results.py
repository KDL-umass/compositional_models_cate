...
plt.plot(varying_values, pehe_baseline_values, 'b-', label='Baseline Model')
plt.plot(varying_values, pehe_additive_values, 'r-', label='Additive Model')
...
# Save the plot
plot_dir = f"plots_{data_dist}_{module_function_type}_{composition_type}_covariates_shared_{covariates_shared}"
