...
for test_size in test_sizes:
    ...
    # save all_results
    with open(f"{main_dir}/results/systematic_{args.systematic}/all_results_{args.data_dist}_{args.composition_type}_covariates_shared_{args.covariates_shared}_use_subset_features_{args.use_subset_features}_combined_results.json", "w") as f:
        json.dump(all_results, f)

    # save all_results_train_size
    with open(f"{main_dir}/results/systematic_{args.systematic}/all_results_{args.data_dist}_{args.composition_type}_covariates_shared_{args.covariates_shared}_use_subset_features_{args.use_subset_features}_train_size.json", "w") as f:
        json.dump(all_results_train_size, f)